        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              autoComplete="email"
              className="w-full px-3 py-2.5 rounded-xl border border-subtle bg-card text-primary text-[16px] placeholder:text-white/30 focus:outline-none focus:border-accent transition-colors"
